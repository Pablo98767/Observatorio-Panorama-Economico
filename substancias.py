...
from functions import cath_requests, cath_response 
...
#     "__EVENTTARGET": "ctl00$ContentPlaceHolder1$subs_agru padora"
# })
...
substancias_estado_df = substancias_estado_df.drop(["Arreca  dador (Subs. Agrupadora).1"], axis=1)
